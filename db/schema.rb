...
ActiveRecord::Schema.define(version: 2021_01_03_140335) do
  ...
  create_table "add_subtotal_to_orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
